...
{% highlight js %} $(function () { $('[data-toggle="tooltip"]').tooltip()
})
{% endhighlight %}
...
{% highlight js %} $('#example').tooltip(options)
{% endhighlight %}
...
{% highlight js %} $('#example').tooltip({ boundary: 'window' })
{% endhighlight %} {% endcapture %} {% include callout.html content=callout type="warning" %}
...
keyboard users. {% endcapture %} {% include callout.html content=callout type="warning" %}
...
{% capture callout %} Note that for security reasons the `sanitize`, `sanitizeFn` and `whiteList` options cannot be
supplied using data attributes. {% endcapture %} {% include callout.html content=callout type="warning" %}
