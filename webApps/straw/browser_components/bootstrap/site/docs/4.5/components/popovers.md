...
{% highlight js %} $(function () { $('[data-toggle="popover"]').popover()
})
{% endhighlight %}
...
{% highlight js %} $('.popover-dismiss').popover({ trigger: 'focus' })
{% endhighlight %}
...
consider using a modal dialog instead. {% endcapture %} {% include callout.html content=callout type="warning" %}
