---
layout: docs title: Wall of browser bugs group: browser-bugs redirect_from: "/browser-bugs/"
---
...
purposes now and will be removed in our next major release. {% endcapture %} {% include callout.html content=callout
type="danger" %}
